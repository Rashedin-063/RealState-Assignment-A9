...
const ClientReview = () => {
  return (
    <div
      ...
      className='bg-slate-900 rounded-lg shadow-md text-white font-merriweather'
    >
      <h1 className='text-4xl text-center py-8 font-semibold mt-16'>
        Our Client's Feedback
      </h1>
      <hr className='w-3/4 lg:w-1/3 border-dotted mx-auto' />
        ...
        <div className='p-4 w-96 bg-slate-800 rounded-lg shadow-md mr-4'>
          <div className='h-full p-8 rounded shadow-[0px_4px_12px_rgba(0,0,0,0.1)]'>
            ...
            <p className='leading-relaxed mb-6 '>
              ...
              professionalism and dedication ensured we found the perfect home.
            </p>
        ...
        <div className='p-4 w-96 bg-slate-800 rounded-lg shadow-md mr-4'>
          <div className='h-full p-8 rounded shadow-[0px_4px_12px_rgba(0,0,0,0.1)]'>
            ...
            <p className='leading-relaxed mb-6 text-gray-300'>
              ...
              property. Their service is top-notch, and we couldn't be happier.
            </p>
            <div className='flex items-center gap-5'>
              <img
                src={Client6}
